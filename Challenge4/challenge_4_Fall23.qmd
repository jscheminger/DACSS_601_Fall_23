...
# Used geom bar to plot number values for income; again, easy to interpret
...
1.  Read in data. **(2.5%)**
    ...
    Austr_long <- pivot_longer(Austr_total, cols = everything(), names_to = "Response", values_to = "Total")
...
bar_plot <- ggplot(Austr_long, aes(x = Total, y = Response)) +
